...
export function createBuildingGeometry(model) {
    ...
    const walls = createWallGeometry(
        model,
        envelope
    );
    ...
    const foundation = createFoundationGeometry(
        model,
        envelope
    );

    const openings = createOpeningGeometry(
        model,
        envelope,
        walls,
        roof
    ...
    return createBuildingGeometryContract({
        model,
        envelope,
        walls,
        roof,
