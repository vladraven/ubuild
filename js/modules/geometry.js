...
export const profileGeoConfigs = {
    'ws200': {
        tileW: 0.80,
        ribs: [
            { pos: 0.00, d: 0.06, w: 0.04 },
            { pos: 0.38, d: 0.06, w: 0.04 },
        ]
    },
    'ws279': {
        tileW: 0.90,
        ribs: [
            { pos: 0.00, d: 0.06, w: 0.04 },
            { pos: 0.43, d: 0.06, w: 0.04 },
        ]
    },
    'snap16': {
        tileW: 0.40,
        ribs: [
            { pos: 0.00, d: 0.04, w: 0.02 },
        ]
    },
    'snap12': {
        tileW: 0.30,
    ...
    'tough': {
        tileW: 0.50,
        ribs: [
            { pos: 0.05, d: 0.06, w: 0.08 },
            { pos: 0.25, d: 0.06, w: 0.08 },
        ]
    },
    'awr': {
        tileW: 0.50,
    ...
    'rainbow': {
        tileW: 0.76,
        ribs: [
            { pos: 0.00, d: 0.05, w: 0.10 },
            { pos: 0.25, d: 0.05, w: 0.10 },
            { pos: 0.50, d: 0.05, w: 0.10 },
        ]
    },
    '936': {
        tileW: 0.914,
        ribs: [
            { pos: 0.00, d: 0.08, w: 0.06 },
            { pos: 0.30, d: 0.08, w: 0.06 },
            { pos: 0.61, d: 0.08, w: 0.06 },
        ]
    },
    'diamond36': {
        tileW: 0.914,
        ribs: [
            { pos: 0.00, d: 0.07, w: 0.05 },
            { pos: 0.20, d: 0.04, w: 0.03 }, 
            { pos: 0.46, d: 0.07, w: 0.05 },
            { pos: 0.66, d: 0.04, w: 0.03 },
        ]
    },
    'diamond30': {
        tileW: 0.762,
        ribs: [
            { pos: 0.00, d: 0.07, w: 0.05 },
            { pos: 0.18, d: 0.04, w: 0.03 },
            { pos: 0.38, d: 0.07, w: 0.05 },
            { pos: 0.56, d: 0.04, w: 0.03 },
        ]
    },
    'corr78': {
        tileW: 0.686,
        ribs: [
            { pos: 0.00, d: 0.022, w: 0.048 },
            { pos: 0.096, d: 0.022, w: 0.048 },
            { pos: 0.192, d: 0.022, w: 0.048 },
            { pos: 0.288, d: 0.022, w: 0.048 },
            { pos: 0.384, d: 0.022, w: 0.048 },
            { pos: 0.480, d: 0.022, w: 0.048 },
            { pos: 0.576, d: 0.022, w: 0.048 },
        ]
    },
    'corr12': {
        tileW: 0.30,
        ribs: [
            { pos: 0.00, d: 0.012, w: 0.030 },
            { pos: 0.06, d: 0.012, w: 0.030 },
            { pos: 0.12, d: 0.012, w: 0.030 },
            { pos: 0.18, d: 0.012, w: 0.030 },
            { pos: 0.24, d: 0.012, w: 0.030 },
        ]
    },
    'diamondLap': {
        tileW: 0.914,
        ribs: [
            { pos: 0.00, d: 0.07, w: 0.05 },
            { pos: 0.30, d: 0.04, w: 0.03 },
            { pos: 0.46, d: 0.07, w: 0.05 },
            { pos: 0.76, d: 0.04, w: 0.03 },
        ]
    },
    'widespan': {
        tileW: 1.00,
    ...
    'elite': {
        ...
        ribs: [
            { pos: 0.00, d: 0.04, w: 0.02 },
            { pos: 0.20, d: 0.02, w: 0.015 },
        ]
    },
    'ultra': {
        tileW: 0.60,
        ribs: [
            { pos: 0.00, d: 0.05, w: 0.04 },
            { pos: 0.15, d: 0.03, w: 0.025 },
            { pos: 0.30, d: 0.05, w: 0.04 },
            { pos: 0.45, d: 0.03, w: 0.025 },
        ]
    },
    'delta': {
        tileW: 0.50,
        ribs: [
            { pos: 0.00, d: 0.06, w: 0.05 },
            { pos: 0.25, d: 0.06, w: 0.05 },
        ]
    },
    'wd36': {
        tileW: 0.914,
        ribs: [
            { pos: 0.00, d: 0.07, w: 0.05 },
            { pos: 0.30, d: 0.07, w: 0.05 },
            { pos: 0.61, d: 0.07, w: 0.05 },
        ]
    },
    'imp': {
        tileW: 1.00,
...
export function createRibbedGeo(w, h, totalH, yOff = 0, profileCfg = null) {
    ...
    const s = new THREE.Shape();
    // Строим профиль вертикально: Y - высота, X - глубина ребра
    s.moveTo(0, 0);
    let y = 0;
    while (y < h) {
        ribs.forEach(rib => {
            const ribY = y + rib.pos;
            if (ribY >= h) return;
            s.lineTo(0, ribY);
            const ribTop = Math.min(ribY + rib.w, h);
            s.lineTo(rib.d, ribY + rib.w * 0.25);
            s.lineTo(rib.d, ribY + rib.w * 0.75);
            s.lineTo(0, ribTop);
        });
        y += tileW;
    }
    ...
    // UV координаты теперь считаем корректно для вертикального листа
