...
function createWindow(opening, context) {
    ...
    const frameMaterial = resolveMaterial(
        context,
        'frame',
        context.colors?.trim
    );

    const glassMaterial = resolveMaterial(
        context,
        'glass',
...
function createWalkDoor(opening, context, doubleDoor) {
    ...
    const panelMaterial = resolveMaterial(
        context,
        'doorPanel',
        context.colors?.wall
    );

    const trimMaterial = resolveMaterial(
        context,
        'doorTrim',
        context.colors?.trim
    );
