...
export const steelMat = new THREE.MeshStandardMaterial({ color: 0x2c3e50, metalness: 0.7, roughness: 0.3, envMapIntensity: 1.2 });
...
export const mezzMat = new THREE.MeshStandardMaterial({ metalness: 0.4, roughness: 0.4, side: THREE.DoubleSide });
export const intWallMat = new THREE.MeshStandardMaterial({ color: 0xeeeeee, metalness: 0.15, roughness: 0.5, side: THREE.DoubleSide });
