...
export const logoPlateMat = new THREE.MeshStandardMaterial({
    color: 0xeeeeee,
    roughness: 0.4,
    metalness: 0
});
...
export const doorPanelMat = new THREE.MeshStandardMaterial({
    color: 0xdddddd,
    roughness: 0.8
});

export const doorTrimMat = new THREE.MeshStandardMaterial({
    color: 0x334155,
    roughness: 0.5
});
...
export const grassMeshMat = new THREE.MeshStandardMaterial({
    bumpScale: 0.15,
    vertexColors: true,
    roughness: 1.95,
    metalness: 0.0
